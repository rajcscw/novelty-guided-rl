...
from archived.components.openai_baselines.common.policies import build_policy
from functools import reduce
try:
    from mpi4py import MPI
except ImportError:
    MPI = None
from archived.components.openai_baselines.ppo2.runner import Runner
...
def learn(*, network, env, seed=None, nsteps, nEps, nItrs, nbatch_train, log_every, ent_coef, lr,
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    if model_fn is None:
        from archived.components.openai_baselines.ppo2 import Model
        model_fn = Model
